...
import io.github.jvlealc.marketsphere.shipping.outbox.UndeliverableOutboxMessageException;
...
import io.github.jvlealc.marketsphere.shipping.shipment.messaging.MessagingDeserializationException;
...
public class KafkaErrorHandlingConfig {
    ...
    public DefaultErrorHandler kafkaErrorHandler(KafkaTemplate<String, String> kafkaTemplate) {
        ...
        errorHandler.addNotRetryableExceptions(
                ...
                UndeliverableOutboxMessageException.class,
                InvalidShipmentException.class,
                IllegalShipmentStatusChangeException.class
        );
    ...
    private static final class DeadLetterRetryListener implements RetryListener {
        ...
        public void failedDelivery(ConsumerRecord<?, ?> record, Exception ex, int deliveryAttempt) {
            log.warn("Delivery attempt {} failed for {}-{} offset {}:{}", deliveryAttempt, record.topic(), record.partition(),
                    record.offset(), DLT_SUFFIX, ex);
        }
