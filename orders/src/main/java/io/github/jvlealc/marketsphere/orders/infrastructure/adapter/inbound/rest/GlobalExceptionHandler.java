package io.github.jvlealc.marketsphere.orders.infrastructure.adapter.inbound.rest;
...
import io.github.jvlealc.marketsphere.orders.application.customer.CustomerAddressMissingException;
import io.github.jvlealc.marketsphere.orders.application.customer.CustomerInactiveException;
import io.github.jvlealc.marketsphere.orders.application.customer.CustomerNotFoundException;
import io.github.jvlealc.marketsphere.orders.application.order.OrderNotFoundException;
import io.github.jvlealc.marketsphere.orders.application.order.query.OrderItemsMissingException;
import io.github.jvlealc.marketsphere.orders.application.product.ProductNotFoundException;
import io.github.jvlealc.marketsphere.orders.application.product.ProductUnavailableException;
...
import io.github.jvlealc.marketsphere.orders.infrastructure.adapter.inbound.rest.payment.webhook.InvalidWebhookSecretException;
...
class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        problemDetail.setType(URI.create("urn:error:" + HttpStatus.UNPROCESSABLE_ENTITY.value()));
