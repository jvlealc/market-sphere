...
import io.github.jvlealc.marketsphere.orders.domain.order.OrderDomainException;
...
public class KafkaErrorHandlingConfiguration {
    ...
    @Bean
    public NewTopic billedOrdersDeadLetterTopic(KafkaTopicsProperties topics) {
    ...
    @Bean
    public NewTopic preparingShipmentOrdersDeadLetterTopic(KafkaTopicsProperties topics) {
    ...
    @Bean
    public NewTopic shippedOrdersDeadLetterTopic(KafkaTopicsProperties topics) {
