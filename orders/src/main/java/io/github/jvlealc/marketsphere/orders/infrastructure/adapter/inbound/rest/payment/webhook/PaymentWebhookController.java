...
import io.github.jvlealc.marketsphere.orders.application.order.payment.HandlePaymentConfirmationUseCase;
...
class PaymentWebhookController {
    ...
    private final PaymentWebhookRestMapper webhookMapper;
