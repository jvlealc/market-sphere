...
import io.github.jvlealc.marketsphere.orders.application.outbox.OutboxAggregateType;
...
import io.github.jvlealc.marketsphere.orders.application.outbox.OutboxStatus;
...
/**
 * Usa {@link Persistable} para que entidades com UUID gerado pela aplicação
 * sejam tratadas como novas no primeiro save (persist em vez de merge).
 */
@Entity
...
@ToString
public class OutboxMessageJpaEntity implements Persistable<UUID> {
