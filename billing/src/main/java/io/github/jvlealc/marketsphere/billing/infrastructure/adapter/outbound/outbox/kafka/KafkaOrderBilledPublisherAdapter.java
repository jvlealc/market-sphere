package io.github.jvlealc.marketsphere.billing.infrastructure.adapter.outbound.outbox.kafka;
...
import io.github.jvlealc.marketsphere.billing.infrastructure.kafka.KafkaTopicsProperties;
import io.github.jvlealc.marketsphere.billing.infrastructure.config.outbox.OutboxRelayProperties;
import io.github.jvlealc.marketsphere.billing.infrastructure.kafka.EventHeaders;
...
class KafkaOrderBilledPublisherAdapter implements OrderBilledPublisherPort {
    ...
    KafkaOrderBilledPublisherAdapter(
            ...
            OutboxRelayProperties outboxRelayProps
    ) {
