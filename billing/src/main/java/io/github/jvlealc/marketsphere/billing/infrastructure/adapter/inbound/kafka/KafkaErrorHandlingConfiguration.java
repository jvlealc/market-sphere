...
import io.github.jvlealc.marketsphere.billing.application.invoice.UnbillableOrderException;
import io.github.jvlealc.marketsphere.billing.domain.invoice.InvoiceDomainException;
...
public class KafkaErrorHandlingConfiguration {
     ...
     */
    @Bean
    public NewTopic paidOrdersDeadLetterTopic(KafkaTopicsProperties topics) {
